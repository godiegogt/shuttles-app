...
import ShuttlesInfo from '../routes/ShuttlesInfo/ShuttlesInfo'; 
...
const BaseRouting = () => {
  ...
  const router = createBrowserRouter(
    createRoutesFromElements(
      <Route>
        ...
        <Route path="shuttles-info/:shuttleId" element={<ShuttlesInfo />} /> 
  ...
  return (
    <>
      {isAuth ? <RouterProvider router={router} /> : <SignIn />}
    </>
  );
}
